...
myLib.desktop.deskIcon={
	...
	arrangeIcons:function(){
		 var myData=myLib.desktop.getMydata()
		    ,winWh=myData.winWh
			,$deskIconBlock=myData.panel.deskIcon['_this']//获取id为deskIcon的ul标签
			,$icon=myData.panel.deskIcon['icon'];//获取class为desktop_icon的li标签
		 //设置桌面图标容器元素区域大小
	...
	init:function(){
		 ...
		 $icon.hover(function(){
						...
						icons.removeClass("desktop_icon_over");
						icons.removeClass("desktop_icon_over_click");
						...
						$(this).bind("click",function(e){
							$("body").unbind("click");
							var path=$("#deskIcon").attr("path")+'/desktop/delFromDeskTop.jhtml';
						    icon.removeClass("desktop_icon_over");
							icon.addClass("desktop_icon_over_click");
							var id=icon.attr("dataid");
							var tid=icon.attr("tid");
							var type=icon.attr("name");
							$("#smartMenu_body").remove();
							 data=[
									[{
									text:"删除图标",
						 ...
						 function(){
							 ...
							 // $(this).unbind("mousedown");
							  $("body").bind("click",function(){
									//icon.removeClass("desktop_icon_over_click");
