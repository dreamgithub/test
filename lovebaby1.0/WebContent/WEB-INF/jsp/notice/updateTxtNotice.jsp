...
<body>
		...
		<div style="width: 800px;margin: auto">
				<form action="${path }/webnotice/addnotice.jhtml" >
					...
					<div style="width: 700px;min-height: 420px;border-style: solid; border-width: thin;border-color :#e1e1e1;margin-top: 10px">
						<textarea rows="10" cols="10" style="width: 100%" id="mycontent">${result.result.content }</textarea>
	...
	<div style="display:none;position: absolute;margin-top: -400px;" id="sel_district">
