	...
	<div class="main-container">
		<nav class="main-nav">
			...
			<ul class="nav right center-text">
				...
				<li id="shangchuan" class="btn active">我的上传</li>
							...
							<div class="portfolio-group ">
								<a class="portfolio-item" href="${data.ftpimage }">
									...
									<span class="detail">
										...
										<span  class="btn use" style="float: left;"><span class="choose" title="${data.name }">使用</span></span>
										<span  class="btn del" style="float: left;margin-left: 85px"><span class="delete" title="${data.id }">删除</span></span>
									</span>
								</a>				
							</div>		
						</c:forEach>		
